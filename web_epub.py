...
# ==========================================
# 5. Streamlit 界面 (V12.2 Final)
# ==========================================
st.set_page_config(page_title="电子书精排 V12.2", page_icon="🎨", layout="centered")

if 'processed_path' not in st.session_state:
    st.session_state.processed_path = None

# --- 上传区域 (Priority #1) ---
st.title("📚 电子书精排工具 V12.2")
